...
The platform offers several methods of generating a new visualization from a data view.
...
You may choose a chart for a Comparison In Time (Line chart and Area chart) or a Comparison Among Items (Bar chart and Column chart), Static Composition (Pie chart) or Elements on a Map to create a map.
...
6.1 Editing and Deleting Visualizations
---------------------------------------
...
+ View Data View: When selecting this option, the user accesses the original data view.
